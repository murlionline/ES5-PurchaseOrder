sap.ui.define([
	...
	return BaseObject.extend("com.sap.model.GroupSortState", {
		 ...
		 * @alias com.sap.model.GroupSortState
		 */
		...
		/**
		 * Sorts by OrderedByName, or by GrossAmount
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GrossAmount") {
				...
				this._oViewModel.setProperty("/sortBy", "OrderedByName");
			}
